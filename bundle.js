(() => {
                                ...
                                function v(e, t) {
                                    ...
                                    if (
                                        ((r.filename = (function (e, t) {
                                            ...
                                            else if ((t.filename && ((s = n.resolveInclude(e, t.filename)), i.existsSync(s) && (r = s)), !r && Array.isArray(a) && (r = h(e, a)), !r && "function" != typeof t.includer))
                                            ...
                                            i.length
                                                ? ((t = i.shift()),
                                                  i.length
                                                      ...
                                                      : (t.settings && (t.settings.views && (a.views = t.settings.views), t.settings["view cache"] && (a.cache = !0), (n = t.settings["view options"]) && s.shallowCopy(a, n)),
                                    ...
                                    (x.prototype = {
                                        ...
                                        generateSource: function () {
                                            ...
                                            t &&
                                                ...
                                                t.forEach(function (s, a) {
                                                    var o;
                                                    if (0 === s.indexOf(i + n) && 0 !== s.indexOf(i + n + n) && (o = t[a + 2]) != n + r && o != "-" + n + r && o != "_" + n + r)
                                        ...
                                        parseTemplateText: function () {
                                            for (var e, t = this.templateText, n = this.regex, i = n.exec(t), r = []; i; )
                                                0 !== (e = i.index) && (r.push(t.substring(0, e)), (t = t.slice(e))), r.push(i[0]), (t = t.slice(i[0].length)), (i = n.exec(t));
                                            return t && r.push(t), r;
                                        },
                        ...
                        6: [
                            function (e, t, n) {
                                t.exports = {
                                    ...
                                    devDependencies: { browserify: "^16.5.1", eslint: "^6.8.0", "git-directory-deploy": "^1.5.1", jsdoc: "^3.6.4", "lru-cache": "^4.0.1", mocha: "^7.1.1", "uglify-js": "^3.3.16" },
                                    engines: { node: ">=0.10.0" },
                                    scripts: { test: "mocha" },
                                };
                            },
    ...
    (() => {
        ...
        var e = n(481),
            ...
            r = n(748);
        function s(e, n = {}) {
            n.title || (n.title = new Date().toLocaleString("ru-RU", { timeZone: "Europe/Moscow" }).replace(". ", "")),
